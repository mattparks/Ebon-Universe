...
public enum Element {
	...
	SCANDIUM(21, 44.9559, 2.985, 3.4E-5, new Isotope[]{
			new Isotope(45, 24, 44.955914, 100.0),
	}),
	TITANIUM(22, 47.867, 4.507, 0.0024, new Isotope[]{
	...
	VANADIUM(23, 50.9415, 6.11, 2.9E-4, new Isotope[]{
			new Isotope(50, 27, 49.947161, 0.25),
			new Isotope(51, 28, 50.943963, 99.75),
	}),
	CHROMIUM(24, 51.9961, 7.14, 0.013, new Isotope[]{
	...
	MANGANESE(25, 54.938, 7.47, 0.0095, new Isotope[]{
			new Isotope(55, 30, 54.938046, 100.0),
	}),
	IRON(26, 55.845, 7.874, 0.9, new Isotope[]{
	...
	COBALT(27, 58.9332, 8.9, 0.0023, new Isotope[]{
			new Isotope(59, 32, 58.933198, 100.0),
	}),
	NICKEL(28, 58.6934, 8.908, 0.05, new Isotope[]{
	...
	COPPER(29, 63.546, 8.92, 5.2E-4, new Isotope[]{
			new Isotope(63, 34, 62.929599, 69.17),
			new Isotope(65, 36, 64.927792, 30.83),
	}),
	ZINC(30, 65.39, 7.14, 0.0013, new Isotope[]{
	...
	GALLIUM(31, 69.723, 5.904, 3.8E-5, new Isotope[]{
			new Isotope(69, 38, 68.925581, 60.1),
			new Isotope(71, 40, 70.924701, 39.9),
	}),
	GERMANIUM(32, 72.64, 5.323, 1.2E-4, new Isotope[]{
	...
	ARSENIC(33, 74.9216, 5.727, 6.6E-6, new Isotope[]{
			new Isotope(75, 42, 74.921596, 100.0),
	}),
	SELENIUM(34, 78.96, 4.819, 6.3E-5, new Isotope[]{
	...
	BROMINE(35, 79.904, 3.12, 1.2E-5, new Isotope[]{
			new Isotope(79, 44, 78.918336, 50.69),
			new Isotope(81, 46, 80.91629, 49.31),
	}),
	KRYPTON(36, 83.8, 0.00375, 4.8E-5, new Isotope[]{
	...
	RUBIDIUM(37, 85.4678, 1.532, 7.0E-6, new Isotope[]{
			new Isotope(85, 48, 84.9118, 72.17),
			new Isotope(87, 50, 86.909184, 27.84),
	}),
	STRONTIUM(38, 87.62, 2.63, 2.4E-5, new Isotope[]{
	...
	YTTRIUM(39, 88.9059, 4.472, 4.6E-6, new Isotope[]{
			new Isotope(89, 50, 88.905856, 100.0),
	}),
	ZIRCONIUM(40, 91.224, 6.511, 1.14E-5, new Isotope[]{
	...
	NIOBIUM(41, 92.9064, 8.57, 7.0E-7, new Isotope[]{
			new Isotope(93, 52, 92.906378, 100.0),
	}),
	MOLYBDENUM(42, 95.94, 10.28, 2.6E-6, new Isotope[]{
	...
	TECHNETIUM(43, 98.0, 11.5, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	RUTHENIUM(44, 101.07, 12.37, 1.9E-6, new Isotope[]{
	...
	RHODIUM(45, 102.9055, 12.45, 3.4E-7, new Isotope[]{
			new Isotope(103, 58, 102.905503, 100.0),
	}),
	PALLADIUM(46, 106.42, 12.023, 1.4E-6, new Isotope[]{
	...
	SILVER(47, 107.8682, 10.49, 4.9E-7, new Isotope[]{
			new Isotope(107, 60, 106.905095, 51.84),
			new Isotope(109, 62, 108.904754, 48.16),
	}),
	CADMIUM(48, 112.411, 8.65, 1.6E-6, new Isotope[]{
	...
	INDIUM(49, 114.818, 7.31, 1.9E-7, new Isotope[]{
			new Isotope(113, 64, 112.904056, 4.3),
			new Isotope(115, 66, 114.903875, 95.7),
	}),
	TIN(50, 118.71, 7.31, 3.9E-6, new Isotope[]{
	...
	ANTIMONY(51, 121.76, 6.697, 3.1E-7, new Isotope[]{
			new Isotope(121, 70, 120.903824, 57.3),
			new Isotope(123, 72, 122.904222, 42.7),
	}),
	TELLURIUM(52, 127.6, 6.24, 4.9E-6, new Isotope[]{
	...
	IODINE(53, 126.9045, 4.94, 9.0E-7, new Isotope[]{
			new Isotope(127, 74, 126.904477, 100.0),
	}),
	XENON(54, 131.293, 0.0059, 4.8E-6, new Isotope[]{
	...
	CESIUM(55, 132.9055, 1.879, -1.0, new Isotope[]{
			new Isotope(133, 78, 132.905433, 100.0),
	}),
	BARIUM(56, 137.327, 3.51, 4.5E-6, new Isotope[]{
	...
	LANTHANUM(57, 138.9055, 6.146, 4.4E-7, new Isotope[]{
			new Isotope(138, 81, 137.907114, 0.09),
			new Isotope(139, 82, 138.906355, 99.91),
	}),
	CERIUM(58, 140.116, 6.689, 1.1E-6, new Isotope[]{
	...
	PRASEODYMIUM(59, 140.9077, 6.64, 1.7E-7, new Isotope[]{
			new Isotope(141, 82, 140.907657, 100.0),
	}),
	NEODYMIUM(60, 144.24, 7.01, 8.3E-7, new Isotope[]{
	...
	PROMETHIUM(61, 145.0, 7.264, -1.0, new Isotope[]{
			new Isotope(145, 84, 145.0, 100.0),
	}),
	SAMARIUM(62, 150.36, 7.353, 2.6E-7, new Isotope[]{
	...
	EUROPIUM(63, 151.964, 5.244, 9.7E-8, new Isotope[]{
			new Isotope(151, 88, 150.91986, 47.8),
			new Isotope(153, 90, 152.921243, 52.2),
	}),
	GADOLINIUM(64, 157.25, 7.901, 3.3E-7, new Isotope[]{
	...
	TERBIUM(65, 158.9253, 8.219, 6.0E-8, new Isotope[]{
			new Isotope(159, 94, 158.92535, 100.0),
	}),
	DYSPROSIUM(66, 162.5, 8.551, 4.0E-7, new Isotope[]{
	...
	HOLMIUM(67, 164.9303, 8.795, 8.9E-8, new Isotope[]{
			new Isotope(165, 98, 164.930332, 100.0),
	}),
	ERBIUM(68, 167.259, 9.066, 6.0E-8, new Isotope[]{
	...
	THULIUM(69, 168.9342, 9.321, 3.8E-8, new Isotope[]{
			new Isotope(169, 100, 168.934225, 100.0),
	}),
	YTTERBIUM(70, 173.04, 6.57, 2.5E-7, new Isotope[]{
	...
	LUTETIUM(71, 174.967, 9.841, 3.7E-8, new Isotope[]{
			new Isotope(175, 104, 174.940785, 97.4),
			new Isotope(176, 105, 175.942694, 2.6),
	}),
	HAFNIUM(72, 178.49, 13.31, 1.5E-7, new Isotope[]{
	...
	TANTALUM(73, 180.9479, 16.65, 3.8E-8, new Isotope[]{
			new Isotope(180, 107, 179.947489, 0.012),
			new Isotope(181, 108, 180.948014, 99.99),
	}),
	TUNGSTEN(74, 183.84, 19.25, 1.3E-7, new Isotope[]{
	...
	RHENIUM(75, 186.207, 21.02, 5.0E-8, new Isotope[]{
			new Isotope(185, 110, 184.952977, 37.4),
			new Isotope(187, 112, 186.955765, 62.6),
	}),
	OSMIUM(76, 190.23, 22.61, 6.7E-7, new Isotope[]{
	...
	IRIDIUM(77, 192.217, 22.65, 6.6E-7, new Isotope[]{
			new Isotope(191, 114, 190.960603, 37.3),
			new Isotope(193, 116, 192.962942, 62.7),
	}),
	PLATINUM(78, 195.078, 21.09, 1.34E-6, new Isotope[]{
	...
	GOLD(79, 196.9665, 19.3, 1.9E-7, new Isotope[]{
			new Isotope(197, 118, 196.96656, 100.0),
	}),
	MERCURY(80, 200.59, 13.534, 3.4E-7, new Isotope[]{
	...
	THALLIUM(81, 204.3833, 11.85, 1.9E-7, new Isotope[]{
			new Isotope(203, 122, 202.972336, 29.52),
			new Isotope(205, 124, 204.97441, 70.48),
	}),
	LEAD(82, 207.2, 11.34, 3.1E-6, new Isotope[]{
	...
	BISMUTH(83, 208.9804, 9.78, 1.4E-7, new Isotope[]{
			new Isotope(209, 126, 208.980388, 100.0),
	}),
	POLONIUM(84, 209.0, 9.196, -1.0, new Isotope[]{
			new Isotope(209, 125, 209.0, 100.0),
	}),
	ASTATINE(85, 210.0, 7.0, -1.0, new Isotope[]{
			new Isotope(210, 125, 210.0, 100.0),
	}),
	RADON(86, 222.0, 0.00973, -1.0, new Isotope[]{
			new Isotope(222, 136, 222.0, 100.0),
	}), // 9.73g/l
	FRANCIUM(87, 223.0, 1.873, -1.0, new Isotope[]{
			new Isotope(223, 136, 223.0, 100.0),
	}),
	RADIUM(88, 226.0, 5.0, -1.0, new Isotope[]{
			new Isotope(226, 138, 226.0, 100.0),
	}),
	ACTINIUM(89, 227.0, 10.07, -1.0, new Isotope[]{
			new Isotope(227, 138, 227.0, 100.0),
	}),
	THORIUM(90, 232.038054, 11.724, 4.5E-8, new Isotope[]{
			new Isotope(232, 142, 232.038054, 100.0),
	}),
	PROTACTINIUM(91, 231.0359, 15.37, -1.0, new Isotope[]{
			new Isotope(231, 140, 231.0359, 100.0),
	}),
	URANIUM(92, 238.0289, 19.05, 1.8E-8, new Isotope[]{
			new Isotope(234, 142, 234.040947, 0.006),
			new Isotope(235, 143, 235.043925, 0.72),
			new Isotope(238, 146, 238.050786, 99.27),
	}),
	NEPTUNIUM(93, 237.0, 20.45, -1.0, new Isotope[]{
			new Isotope(237, 144, 237.0, 100.0),
	}),
	PLUTONIUM(94, 244.0, 19.816, -1.0, new Isotope[]{
			new Isotope(244, 150, 244.0, 100.0),
	}),
	AMERICIUM(95, 243.0, -1.0, -1.0, new Isotope[]{
			new Isotope(243, 148, 243.0, 100.0),
	}),
	CURIUM(96, 247.0, 13.51, -1.0, new Isotope[]{
			new Isotope(247, 151, 247.0, 100.0),
	}),
	BERKELIUM(97, 247.0, 14.78, -1.0, new Isotope[]{
			new Isotope(247, 150, 247.0, 100.0),
	}),
	CALIFORNIUM(98, 251.0, 15.1, -1.0, new Isotope[]{
			new Isotope(251, 153, 251.0, 100.0),
	}),
	EINSTEINIUM(99, 252.0, 8.84, -1.0, new Isotope[]{
			new Isotope(252, 153, 252.0, 100.0),
	}),
	FERMIUM(100, 257.0, 8.84, -1.0, new Isotope[]{
			new Isotope(257, 157, 257.0, 100.0),
	}),
	MENDELEVIUM(101, 258.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	NOBELIUM(102, 259.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	LAWRENCIUM(103, 262.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	RUTHERFORDIUM(104, 261.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	DUBNIUM(105, 262.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	SEABORGIUM(106, 266.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	BOHRIUM(107, 264.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	HASSIUM(108, 277.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	MEITNERIUM(109, 268.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	DARMSTADTIUM(110, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	ROENTGENIUM(111, 272.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	UNUNBIUM(112, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	UNUNTRIUM(113, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	UNUNQUADIUM(114, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	UNUNPENTIUM(115, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	UNUNHEXIUM(116, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	UNUNSEPTIUM(117, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	}),
	UNUNOCTIUM(118, -1.0, -1.0, -1.0, new Isotope[]{
			// No Know Isotopes.
	});
	...
	public static void createTemp() {
		for (int i = 1; i <= ELEMENTS; i++) {
			...
			if (e != null) {
				String data = e.name() + "(" + e.atomicNumber + ", " + e.atomicWeight + ", " + e.density + ", " + e.universeMakeup + ", new Isotope[]{ ";
	...
	Element(int atomicNumber, double atomicWeight, double density, double universeMakeup, Isotope[] isotopes) {
	...
	public static Element getElement(String name) {
		...
		throw new NullPointerException(name + " is not a element!");
	}
