...
public class OptionsControls {
	...
	public static int JOYSTICK_GUI_TOGGLE =
			JOYSTICK_TYPE == Joysticks.XBOX360 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("xbox_guiToggle", 7, () -> OptionsControls.JOYSTICK_GUI_TOGGLE) :
					JOYSTICK_TYPE == Joysticks.F310 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("f310_guiToggle", 9, () -> OptionsControls.JOYSTICK_GUI_TOGGLE) :
							JOYSTICK_TYPE == Joysticks.LOGITECH3D ? MainGame.CONTROLS_CONFIG.getIntWithDefault("logitech3d_guiToggle", 7, () -> OptionsControls.JOYSTICK_GUI_TOGGLE) : 0;
	public static int JOYSTICK_GUI_LEFT =
			JOYSTICK_TYPE == Joysticks.XBOX360 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("xbox_guiLeft", 0, () -> OptionsControls.JOYSTICK_GUI_LEFT) :
	...
	public static int JOYSTICK_GUI_RIGHT =
			JOYSTICK_TYPE == Joysticks.XBOX360 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("xbox_guiRight", 1, () -> OptionsControls.JOYSTICK_GUI_RIGHT) :
	...
	public static int JOYSTICK_ROTATE_X =
			JOYSTICK_TYPE == Joysticks.XBOX360 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("xbox_rotateX", 2, () -> OptionsControls.JOYSTICK_ROTATE_X) :
					JOYSTICK_TYPE == Joysticks.F310 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("f310_axisX", 0, () -> OptionsControls.JOYSTICK_ROTATE_X) :
							JOYSTICK_TYPE == Joysticks.LOGITECH3D ? MainGame.CONTROLS_CONFIG.getIntWithDefault("logitech3d_axisX", 0, () -> OptionsControls.JOYSTICK_ROTATE_X) : 0;
	...
	public static int JOYSTICK_MUSIC_PAUSE =
			JOYSTICK_TYPE == Joysticks.XBOX360 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("xbox_musicPause", 8, () -> OptionsControls.JOYSTICK_MUSIC_PAUSE) :
	...
	public static int JOYSTICK_MUSIC_SKIP =
			JOYSTICK_TYPE == Joysticks.XBOX360 ? MainGame.CONTROLS_CONFIG.getIntWithDefault("xbox_musicSkip", 9, () -> OptionsControls.JOYSTICK_MUSIC_SKIP) :
