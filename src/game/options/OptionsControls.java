...
public class OptionsControls {
	public static Joysticks JOYSTICK_TYPE = Joysticks.LOGITECH3D;

	public static int JOYSTICK_PORT = 0;

	public static int JOYSTICK_GUI_TOGGLE = JOYSTICK_TYPE == Joysticks.XBOX360 ? 7 : JOYSTICK_TYPE == Joysticks.F310 ? 9 : 7;
	public static int JOYSTICK_GUI_LEFT = JOYSTICK_TYPE == Joysticks.XBOX360 ? 2 : JOYSTICK_TYPE == Joysticks.F310 ? 0 : 2;
	public static int JOYSTICK_GUI_RIGHT = JOYSTICK_TYPE == Joysticks.XBOX360 ? 3 : JOYSTICK_TYPE == Joysticks.F310 ? 3 : 3;
