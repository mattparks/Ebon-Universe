...
public class ParticleSystem {
	...
	private void emitParticle() {
		...
		EbonParticles.addParticle(emitType, spawnPos, velocity, lifeLength, generateRotation(), scale, gravityEffect);
	}
	...
	public void delete() {
		EbonParticles.removeSystem(this);
	}
}
